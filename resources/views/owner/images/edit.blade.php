              ...
              <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form id="delete_{{ $image->id }}" method="POST" action="{{ route('owner.images.destroy', ['image' => $image->id ])}}">
                  ...
                  <div class="p-2 w-full flex justify-around mt-16">
                    <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" type="submit" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除</a>
                  </div>
                </form>
              </div>
          </div>
